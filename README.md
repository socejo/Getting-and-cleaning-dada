...
нннннн__TidyTrain__ contains the train data tidyed according to what is explained on the codebook.md file  

__TidyTest__ contains the test data tidyed according to what is explained on the codebook.md file  

__TidyAverage__ contains the data as requested on step 5 of the assignment instructions